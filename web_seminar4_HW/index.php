...
$jobs = [
    [
        'name' => 'Head of Logistics department',
        'startDate' => 'Sep 2020',
        'endDate' => 'Current',
        'description' => 'Checking how other people work)',
    ],
    [
        'name' => 'Logistics group lead ',
        'startDate' => 'Dec 2012',
        'endDate' => 'Sep 2020',
        'description' => 'Doing a lot of unnecessary tasks',
    ],
    [
       'name' => 'Logistics assistant',
        'startDate' => 'Aug 2008',
        'endDate' => 'Dec 2012',
        'description' => 'Looking at people with big cat eyes',
    ],
];
?>
<!DOCTYPE html>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
              ...
              <?php for ($i = 0; $i < count($jobs); $i++): ?>
                <div class="w3-container">
                    <h5 class="w3-opacity"><b><p><?php echo $jobs[$i]['name'];?></p></b></h5>
                    <h6 class="w3-text-teal">
                    <i class="fa fa-calendar fa-fw w3-margin-right"></i>
                    <?php echo $jobs[$i]['startDate'];?> - 
                    <?php if ($i == 0) : ?>
                    <span class="w3-tag w3-teal w3-round">
                    <?php echo $jobs[$i]['endDate'];?></span>
                    <?php else: ?>
                    <?php echo $jobs[$i]['endDate'];?>
                    <?php endif; ?>
                    </h6>
